...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Approved Listings</h6>
                    <p class="text-muted mb-3">List of all approved property listings</p>
                        ...
                        <table id="dataTableUser" class="table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT pl.listing_id, pl.user_id, pl.property_name, pl.bedroom_count, pl.unit_price, pl.city, pl.address, CONCAT(u.first_name, ' ', u.last_name) AS agent_name, u.phone, u.email,
                                        ...
                                        WHERE pl.verification = 1 AND pl.delete_flag = 0";
                                        ...
                                        echo "<td>
                                                <div class='dropdown'>
                                                    ...
                                                    <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                        ...
                                                        <li><a class='dropdown-item delete-listing' href='#' data-listing-id='" . htmlspecialchars($listingId) . "'>Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>";
                                        echo "</tr>";
