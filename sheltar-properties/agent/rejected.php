        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">List of all rejected submissions</p>
                    <div class="table-responsive">
                        <table id="dataTableUser" class="table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT listing_id, property_name, bedroom_count, unit_price, city, address, comment,
                                        CASE 
                                        ...
                                        WHERE verification = 0 AND user_id = $session_user AND delete_flag = 0 ";

                                if ($stmt = mysqli_prepare($conn, $sql)) {
                                    mysqli_stmt_execute($stmt);

                                    mysqli_stmt_bind_result($stmt, $istingId, $propertyName, $bedroomCount, $unitPrice, $city, $address, $comment, $verificationStatus, $listingType, $propertyUse, $propertyType);
