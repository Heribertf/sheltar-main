...
<!--	Title
	=========================================================-->
<title>Sheltar - List Property</title>
</head>
<body>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="h_type" required placeholder="Enter House Type">
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required placeholder="Enter Area Size (in sqr ft)">
													</div>
												</div>
												<div class="form-group row">
